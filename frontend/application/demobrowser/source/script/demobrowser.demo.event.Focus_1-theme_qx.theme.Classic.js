if(!window.qxsettings)qxsettings={};qxsettings["qx.application"]="demobrowser.demo.event.Focus_1";qxsettings["qx.allowUrlVariants"]=true;qxsettings["qx.allowUrlSettings"]=true;if(!window.qxvariants)qxvariants={};qxvariants["qx.theme"]="qx.theme.Classic";
